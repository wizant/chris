...
<?php if( isset( $table_settings['custom-css'] ) && !empty( $table_settings['custom-css'] ) ) {
	//$table_settings['custom-css'] = preg_replace("/\s+/", ' ', $table_settings['custom-css'] );		
	//$table_settings['custom-css'] = preg_replace("/\r\n|\r|\n/", ' ', $table_settings['custom-css'] );
